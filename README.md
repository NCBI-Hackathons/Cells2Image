...
![Learning algorithm for detecting cell structure changes from light microscopy data](images/MalEgreTS.png  | width=100 "Learning algorithm for detecting cell structure changes from light microscopy data")
